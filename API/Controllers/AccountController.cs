...
{ 
  ...
  public class AccountController : ControllerBase
  {
    ...
    public AccountController(UserManager<AppUser> userManage, SignInManager<AppUser> signInManager, TokenService tokenService)
    {
    ...
    {
      var user = await _userManage.FindByEmailAsync(User.FindFirstValue(ClaimTypes.Email));
